...
class StyleManager extends AssetManager
{
     ...
     * @since 3.0.0
     */
    public function raw(string $rules, string $id = '' ): void
    {
        // if %root% found replace it with id of the element in all the matching rules
        if($id){
            $rules = str_replace('%root%', $id, $rules);
        }
