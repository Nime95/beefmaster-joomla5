      ...
      <div class="qx-width-1-4">
        <div class="qx-card">
          <div class="qx-card-body">
              <?php if ($format === 'html' && \Joomla\CMS\Helper\ModuleHelper::getModule('mod_search')) : ?>
                <p><strong><?php echo \Joomla\CMS\Language\Text::_('JERROR_LAYOUT_SEARCH'); ?></strong></p>
                <p><?php echo \Joomla\CMS\Language\Text::_('JERROR_LAYOUT_SEARCH_PAGE'); ?></p>
                  <?php $module = \Joomla\CMS\Helper\ModuleHelper::getModule('mod_search'); ?>
                  <?php echo \Joomla\CMS\Helper\ModuleHelper::renderModule($module); ?>
              <?php endif; ?>
          </div>
        </div>
      </div>
  ...
  <div class="qx-container">
    ...
    <p class="qx-align-right">
      <a href="#header" id="back-top" class="qx-link-text" qx-scroll>
          <?php echo \Joomla\CMS\Language\Text::_('TPL_ATOM_BACKTOTOP'); ?>
      </a>
    </p>
    <p>
