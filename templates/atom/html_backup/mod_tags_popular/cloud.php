...
<?php
if (!count($list)) : ?>
	<div class="qx-alert alert-no-items"><?php echo \Joomla\CMS\Language\Text::_('MOD_TAGS_POPULAR_NO_ITEMS_FOUND'); ?></div>
<?php else :
...
?>
		<span class="tag">
			<a class="tag-name" style="font-size: <?php echo $fontsize . 'em'; ?>" href="<?php echo \Joomla\CMS\Router\Route::_(TagsHelperRoute::getTagRoute($item->tag_id . ':' . $item->alias)); ?>">
