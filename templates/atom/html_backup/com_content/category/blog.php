    ...
    <?php if ($beforeDisplayContent || $afterDisplayContent || $this->params->get('show_description', 1) || $this->params->def('show_description_image',
      ...
      <div class="category-desc clearfix">
          ...
          <?php if ($this->params->get('show_description') && $this->category->description) : ?>
              <?php //echo \Joomla\CMS\HTML\HTMLHelper::_('content.prepare', $this->category->description, '', 'com_content.category'); ?>
          <?php endif; ?>
          ...
          <?php foreach ($this->lead_items as &$item) : ?>
            <article class="qx-article leading-<?php echo $leadingcount; ?><?php echo $item->state == 0 ? ' system-unpublished' : null; ?>"
              ...
              <meta itemprop="inLanguage"
                    content="<?php echo ($this->item->language === '*') ? \Joomla\CMS\Factory::getConfig()->get('language') : $this->item->language; ?>" />
    ...
    <?php if ($this->maxLevel != 0 && ! empty($this->children[$this->category->id])) : ?>
      <div class="cat-children">
          <?php if ($this->params->get('show_category_heading_title_text', 1) == 1) : ?>
            <h3> <?php echo \Joomla\CMS\Language\Text::_('JGLOBAL_SUBCATEGORIES'); ?> </h3>
          <?php endif; ?>
