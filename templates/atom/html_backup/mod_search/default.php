...
\Joomla\CMS\HTML\HTMLHelper::_('script', 'system/html5fallback.js', array('version' => 'auto', 'relative' => true, 'conditional' => 'lt IE 9'));
...
<div class="search<?php echo $moduleclass_sfx; ?>">
	<form action="<?php echo \Joomla\CMS\Router\Route::_('index.php'); ?>" method="post" class="qx-search qx-search-default" role="search">
		<?php
