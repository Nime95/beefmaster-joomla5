...
if ($showPreview)
{
	...
	{
		$src = \Joomla\CMS\Language\Text::_('JLIB_FORM_MEDIA_PREVIEW_EMPTY');
	}
}
...
>
	<?php
	// Render the modal
	echo \Joomla\CMS\HTML\HTMLHelper::_('bootstrap.renderModal',
		'imageModal_'. $id,
		array(
			'title' => \Joomla\CMS\Language\Text::_('JLIB_FORM_CHANGE_IMAGE'),
			'closeButton' => true,
			'footer' => '<button type="button" class="btn" data-dismiss="modal">' . \Joomla\CMS\Language\Text::_('JCANCEL') . '</button>'
		)
	);

	\Joomla\CMS\HTML\HTMLHelper::_('script', 'media/mediafield.min.js', array('version' => 'auto', 'relative' => true));
	?>
	<?php if ($showPreview && $showAsTooltip) : ?>
	<div class="input-prepend input-append">
		<span rel="popover" class="add-on pop-helper field-media-preview"
			title="<?php echo	\Joomla\CMS\Language\Text::_('JLIB_FORM_MEDIA_PREVIEW_SELECTED_IMAGE'); ?>" data-content="<?php echo \Joomla\CMS\Language\Text::_('JLIB_FORM_MEDIA_PREVIEW_EMPTY'); ?>"
			data-original-title="<?php echo \Joomla\CMS\Language\Text::_('JLIB_FORM_MEDIA_PREVIEW_SELECTED_IMAGE'); ?>" data-trigger="hover">
	...
	<?php endif; ?>
		...
		<?php if ($disabled != true) : ?>
			<button type="button" class="btn button-select"><?php echo \Joomla\CMS\Language\Text::_("JLIB_FORM_BUTTON_SELECT"); ?></button>
			<button
				type="button"
				class="btn hasTooltip button-clear"
				title="<?php echo \Joomla\CMS\Language\Text::_("JLIB_FORM_BUTTON_CLEAR"); ?>"
				aria-label="<?php echo \Joomla\CMS\Language\Text::_("JLIB_FORM_BUTTON_CLEAR"); ?>"
				>
