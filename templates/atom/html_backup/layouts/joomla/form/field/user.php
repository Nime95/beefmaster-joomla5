...
if (\Joomla\CMS\Language\Text::_('JLIB_FORM_SELECT_USER') === htmlspecialchars($userName, ENT_COMPAT, 'UTF-8'))
{
	$userName = '';
}
...
if (!$readonly)
{
	\Joomla\CMS\HTML\HTMLHelper::_('script', 'jui/fielduser.min.js', array('version' => 'auto', 'relative' => true));
}
?>
...
<div class="field-user-wrapper"
	...
	<div class="input-append">
		<input
			...
			placeholder="<?php echo \Joomla\CMS\Language\Text::_('JLIB_FORM_SELECT_USER'); ?>"
			readonly
		...
		<?php if (!$readonly) : ?>
			<button
				...
				title="<?php echo \Joomla\CMS\Language\Text::_('JLIB_FORM_CHANGE_USER') ?>"
				aria-label="<?php echo \Joomla\CMS\Language\Text::_('JLIB_FORM_CHANGE_USER') ?>"
				>
			...
			<?php echo \Joomla\CMS\HTML\HTMLHelper::_(
				...
				'userModal_' . $id,
				array(
					'title'  => \Joomla\CMS\Language\Text::_('JLIB_FORM_CHANGE_USER'),
					'closeButton' => true,
