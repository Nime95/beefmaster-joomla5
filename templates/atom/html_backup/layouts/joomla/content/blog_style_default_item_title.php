...
<?php if ($displayData->state == 0 || $params->get('show_title') || ($params->get('show_author') && !empty($displayData->author ))) : ?>
	...
	<?php if ($displayData->publish_up > $currentDate) : ?>
		<span class="qx-label qx-label-warning"><?php echo \Joomla\CMS\Language\Text::_('JNOTPUBLISHEDYET'); ?></span>
	<?php endif; ?>

	<?php if ($displayData->publish_down < $currentDate && $displayData->publish_down !== \Joomla\CMS\Factory::getDbo()->getNullDate()) : ?>
		<span class="qx-label qx-label-warning"><?php echo \Joomla\CMS\Language\Text::_('JEXPIRED'); ?></span>
	<?php endif; ?>
<?php endif; ?>
