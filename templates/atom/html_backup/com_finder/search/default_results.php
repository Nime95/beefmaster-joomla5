...
<?php if (($this->suggested && $this->params->get('show_suggested_query', 1)) || ($this->explained && $this->params->get('show_explained_query', 1))) : ?>
	<div id="search-query-explained">
		...
		<?php if ($this->suggested && $this->params->get('show_suggested_query', 1)) : ?>
			...
			<?php $linkUrl = \Joomla\CMS\Router\Route::_($uri->toString(array('path', 'query'))); ?>
			<?php $link = '<a href="' . $linkUrl . '">' . $this->escape($this->suggested) . '</a>'; ?>
			<?php echo \Joomla\CMS\Language\Text::sprintf('COM_FINDER_SEARCH_SIMILAR', $link); ?>
...
<?php if (($this->total === 0) || ($this->total === null)) : ?>
	<div id="search-result-empty">
		<h1><?php echo \Joomla\CMS\Language\Text::_('COM_FINDER_SEARCH_NO_RESULTS_HEADING'); ?></h1>
		<?php $multilang = \Joomla\CMS\Factory::getApplication()->getLanguageFilter() ? '_MULTILANG' : ''; ?>
		<p><?php echo \Joomla\CMS\Language\Text::sprintf('COM_FINDER_SEARCH_NO_RESULTS_BODY' . $multilang, $this->escape($this->query->input)); ?></p>
	</div>
...
<?php if (!empty($this->query->highlight) && $this->params->get('highlight_terms', 1)) : ?>
	<?php \Joomla\CMS\HTML\HTMLHelper::_('behavior.highlighter', $this->query->highlight); ?>
<?php endif; ?>
