...
?>
<form id="finder-search" action="<?php echo \Joomla\CMS\Router\Route::_($this->query->toUri()); ?>" method="get" class="form-inline">
				...
				<?php if ($this->escape($this->query->input) != '' || $this->params->get('allow_empty_query')) : ?>
					<div class="qx-width-auto@s">
						<button name="Search" type="submit" class="qx-button qx-button-primary qx-width-1-1">
							...
							<?php echo \Joomla\CMS\Language\Text::_('JSEARCH_FILTER_SUBMIT'); ?>
						</button>
					</div>
				<?php else : ?>
					<div class="qx-width-auto@s">
				...
				<?php if ($this->params->get('show_advanced', 1)) : ?>
					<div class="qx-width-auto@s">
						<a href="#advancedSearch" qx-toggle="target: #advancedSearch" class="qx-button qx-button-default qx-width-1-1" qx-toggle>
							...
							<?php echo \Joomla\CMS\Language\Text::_('COM_FINDER_ADVANCED_SEARCH_TOGGLE'); ?>
						</a>
					</div>
				<?php endif; ?>
				</div>
	...
	<?php if ($this->params->get('show_advanced', 1)) : ?>
		<div id="advancedSearch" class="qx-margin-medium" <?php if (!$this->params->get('expand_advanced', 0)) echo ' hidden'; ?>>
			<?php if ($this->params->get('show_advanced_tips', 1)) : ?>
				<?php echo \Joomla\CMS\Language\Text::_('COM_FINDER_ADVANCED_TIPS'); ?>
			<?php endif; ?>
			<div id="finder-filter-window" style="display:flow-root;">
				<?php echo \Joomla\CMS\HTML\HTMLHelper::_('filter.select', $this->query, $this->params); ?>
			</div>
		</div>
	<?php endif; ?>
</form>
