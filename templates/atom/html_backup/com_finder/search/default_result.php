...
if ($show_description)
{
	...
	$description = \Joomla\CMS\HTML\HTMLHelper::_('string.truncate', StringHelper::substr($full_description, $start), $desc_length, true);
}
...
<article class="qx-article">
	<h4 class="qx-article-title <?php echo $mime; ?>">
		<a class="qx-link-text" href="<?php echo \Joomla\CMS\Router\Route::_($route); ?>">
