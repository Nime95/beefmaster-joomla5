...
<?php if ($tparams->get('show_page_heading')) : ?>
	...
	<?php if ($this->contact->name && $tparams->get('show_name')) : ?>
		<h2 class="qx-heading-small qx-margin-medium qx-margin-remove-top">
			<?php if ($this->item->published == 0) : ?>
				<span class="qx-label qx-label-warning"><?php echo \Joomla\CMS\Language\Text::_('JUNPUBLISHED'); ?></span>
			<?php endif; ?>
	...
	<?php if ($tparams->get('show_contact_list') && count($this->contacts) > 1) : ?>
		<form action="#" method="get" name="selectForm" id="selectForm">
			<label for="select_contact"><?php echo \Joomla\CMS\Language\Text::_('COM_CONTACT_SELECT_CONTACT'); ?></label>
			<?php echo \Joomla\CMS\HTML\HTMLHelper::_('select.genericlist', $this->contacts, 'select_contact', 'class="inputbox" onchange="document.location.href = this.value"', 'link', 'name', $this->contact->link); ?>
		</form>
	<?php endif; ?>
	...
	<?php if ($this->params->get('show_info', 1)) : ?>
		<?php if ($presentation_style === 'sliders') : ?>
			<?php echo \Joomla\CMS\HTML\HTMLHelper::_('bootstrap.startAccordion', 'slide-contact', array('qx-active' => 'basic-details')); ?>
			<?php $accordionStarted = true; ?>
			<?php echo \Joomla\CMS\HTML\HTMLHelper::_('bootstrap.addSlide', 'slide-contact', \Joomla\CMS\Language\Text::_('COM_CONTACT_DETAILS'), 'basic-details'); ?>
		<?php elseif ($presentation_style === 'tabs') : ?>
			<?php echo \Joomla\CMS\HTML\HTMLHelper::_('bootstrap.startTabSet', 'myTab', array('qx-active' => 'basic-details')); ?>
			<?php $tabSetStarted = true; ?>
			<?php echo \Joomla\CMS\HTML\HTMLHelper::_('bootstrap.addTab', 'myTab', 'basic-details', \Joomla\CMS\Language\Text::_('COM_CONTACT_DETAILS')); ?>
		<?php elseif ($presentation_style === 'plain') : ?>
			<?php echo '<h3>' . \Joomla\CMS\Language\Text::_('COM_CONTACT_DETAILS') . '</h3>'; ?>
		<?php endif; ?>

		<div qx-grid>
		<?php if ($this->contact->image && $tparams->get('show_image')) : ?>
			<div class="thumbnail qx-width-1-1 qx-width-1-3@m">
				<?php echo \Joomla\CMS\HTML\HTMLHelper::_('image', $this->contact->image, htmlspecialchars($this->contact->name,  ENT_QUOTES, 'UTF-8'), array('itemprop' => 'image')); ?>
			</div>
		<?php endif; ?>
	...
	<?php if ($tparams->get('show_email_form') && ($this->contact->email_to || $this->contact->user_id)) : ?>
		<?php if ($presentation_style === 'sliders') : ?>
			...
			{
				echo \Joomla\CMS\HTML\HTMLHelper::_('bootstrap.startAccordion', 'slide-contact', array('qx-active' => 'display-form'));
				$accordionStarted = true;
			}
			?>
			<?php echo \Joomla\CMS\HTML\HTMLHelper::_('bootstrap.addSlide', 'slide-contact', \Joomla\CMS\Language\Text::_('COM_CONTACT_EMAIL_FORM'), 'display-form'); ?>
		<?php elseif ($presentation_style === 'tabs') : ?>
			<?php if (!$tabSetStarted)
			{
				echo \Joomla\CMS\HTML\HTMLHelper::_('bootstrap.startTabSet', 'myTab', array('qx-active' => 'display-form'));
				$tabSetStarted = true;
			}
			?>
			<?php echo \Joomla\CMS\HTML\HTMLHelper::_('bootstrap.addTab', 'myTab', 'display-form', \Joomla\CMS\Language\Text::_('COM_CONTACT_EMAIL_FORM')); ?>
		<?php elseif ($presentation_style === 'plain') : ?>
			<?php echo '<h3>' . \Joomla\CMS\Language\Text::_('COM_CONTACT_EMAIL_FORM') . '</h3>'; ?>
		<?php endif; ?>
	...
	<?php if ($tparams->get('show_links')) : ?>
		<?php if ($presentation_style === 'sliders') : ?>
			<?php if (!$accordionStarted) : ?>
				<?php echo \Joomla\CMS\HTML\HTMLHelper::_('bootstrap.startAccordion', 'slide-contact', array('qx-active' => 'display-links')); ?>
				<?php $accordionStarted = true; ?>
			<?php endif; ?>
		<?php elseif ($presentation_style === 'tabs') : ?>
			<?php if (!$tabSetStarted) : ?>
				<?php echo \Joomla\CMS\HTML\HTMLHelper::_('bootstrap.startTabSet', 'myTab', array('qx-active' => 'display-links')); ?>
				<?php $tabSetStarted = true; ?>
			<?php endif; ?>
		<?php endif; ?>
	...
	<?php if ($tparams->get('show_articles') && $this->contact->user_id && $this->contact->articles) : ?>
		<?php if ($presentation_style === 'sliders') : ?>
			<?php if (!$accordionStarted)
			{
				echo \Joomla\CMS\HTML\HTMLHelper::_('bootstrap.startAccordion', 'slide-contact', array('qx-active' => 'display-articles'));
				$accordionStarted = true;
			}
			?>
			<?php echo \Joomla\CMS\HTML\HTMLHelper::_('bootstrap.addSlide', 'slide-contact', \Joomla\CMS\Language\Text::_('JGLOBAL_ARTICLES'), 'display-articles'); ?>
		<?php elseif ($presentation_style === 'tabs') : ?>
			<?php if (!$tabSetStarted)
			{
				echo \Joomla\CMS\HTML\HTMLHelper::_('bootstrap.startTabSet', 'myTab', array('qx-active' => 'display-articles'));
				$tabSetStarted = true;
			}
			?>
			<?php echo \Joomla\CMS\HTML\HTMLHelper::_('bootstrap.addTab', 'myTab', 'display-articles', \Joomla\CMS\Language\Text::_('JGLOBAL_ARTICLES')); ?>
		<?php elseif ($presentation_style === 'plain') : ?>
			<?php echo '<h3>' . \Joomla\CMS\Language\Text::_('JGLOBAL_ARTICLES') . '</h3>'; ?>
		<?php endif; ?>
	...
	<?php if ($tparams->get('show_profile') && $this->contact->user_id && JPluginHelper::isEnabled('user', 'profile')) : ?>
		<?php if ($presentation_style === 'sliders') : ?>
			<?php if (!$accordionStarted)
			{
				echo \Joomla\CMS\HTML\HTMLHelper::_('bootstrap.startAccordion', 'slide-contact', array('qx-active' => 'display-profile'));
				$accordionStarted = true;
			}
			?>
			<?php echo \Joomla\CMS\HTML\HTMLHelper::_('bootstrap.addSlide', 'slide-contact', \Joomla\CMS\Language\Text::_('COM_CONTACT_PROFILE'), 'display-profile'); ?>
		<?php elseif ($presentation_style === 'tabs') : ?>
			<?php if (!$tabSetStarted)
			{
				echo \Joomla\CMS\HTML\HTMLHelper::_('bootstrap.startTabSet', 'myTab', array('qx-active' => 'display-profile'));
				$tabSetStarted = true;
			}
			?>
			<?php echo \Joomla\CMS\HTML\HTMLHelper::_('bootstrap.addTab', 'myTab', 'display-profile', \Joomla\CMS\Language\Text::_('COM_CONTACT_PROFILE')); ?>
		<?php elseif ($presentation_style === 'plain') : ?>
			<?php echo '<h3>' . \Joomla\CMS\Language\Text::_('COM_CONTACT_PROFILE') . '</h3>'; ?>
		<?php endif; ?>
	...
	<?php if ($this->contact->misc && $tparams->get('show_misc')) : ?>
		<?php if ($presentation_style === 'sliders') : ?>
			<?php if (!$accordionStarted)
			{
				echo \Joomla\CMS\HTML\HTMLHelper::_('bootstrap.startAccordion', 'slide-contact', array('qx-active' => 'display-misc'));
				$accordionStarted = true;
			}
			?>
			<?php echo \Joomla\CMS\HTML\HTMLHelper::_('bootstrap.addSlide', 'slide-contact', \Joomla\CMS\Language\Text::_('COM_CONTACT_OTHER_INFORMATION'), 'display-misc'); ?>
		<?php elseif ($presentation_style === 'tabs') : ?>
			<?php if (!$tabSetStarted)
			{
				echo \Joomla\CMS\HTML\HTMLHelper::_('bootstrap.startTabSet', 'myTab', array('qx-active' => 'display-misc'));
				$tabSetStarted = true;
			}
			?>
			<?php echo \Joomla\CMS\HTML\HTMLHelper::_('bootstrap.addTab', 'myTab', 'display-misc', \Joomla\CMS\Language\Text::_('COM_CONTACT_OTHER_INFORMATION')); ?>
		<?php elseif ($presentation_style === 'plain') : ?>
			<?php echo '<h3>' . \Joomla\CMS\Language\Text::_('COM_CONTACT_OTHER_INFORMATION') . '</h3>'; ?>
		<?php endif; ?>
