...
<?php foreach ($userFieldGroups as $groupTitle => $fields) : ?>
	...
	<?php if ($presentation_style == 'sliders') : ?>
		<?php echo \Joomla\CMS\HTML\HTMLHelper::_('bootstrap.addSlide', 'slide-contact', $groupTitle ?: \Joomla\CMS\Language\Text::_('COM_CONTACT_USER_FIELDS'), 'display-' . $id); ?>
	<?php elseif ($presentation_style == 'tabs') : ?>
		<?php echo \Joomla\CMS\HTML\HTMLHelper::_('bootstrap.addTab', 'myTab', 'display-' . $id, $groupTitle ?: \Joomla\CMS\Language\Text::_('COM_CONTACT_USER_FIELDS')); ?>
	<?php elseif ($presentation_style == 'plain') : ?>
		<?php echo '<h3>' . ($groupTitle ?: \Joomla\CMS\Language\Text::_('COM_CONTACT_USER_FIELDS')) . '</h3>'; ?>
	<?php endif; ?>
	...
	<div class="contact-profile" id="user-custom-fields-<?php echo $id; ?>">
		...
		<?php foreach ($fields as $field) : ?>
			...
			<?php if ($field->params->get('showlabel')) : ?>
				<?php echo '<dt>' . \Joomla\CMS\Language\Text::_($field->label) . '</dt>'; ?>
			<?php endif; ?>
