...
<div class="contact-address qx-width-1-1 qx-width-2-3@m" itemprop="address" itemscope itemtype="https://schema.org/PostalAddress">
	<?php if ($this->contact->con_position && $tparams->get('show_position')) : ?>
		<div class="contact-position">
			<div itemprop="jobTitle">
				<strong><?php echo \Joomla\CMS\Language\Text::_('COM_CONTACT_POSITION'); ?>: </strong><?php echo $this->contact->con_position; ?>
			</div>
		</div>
	<?php endif; ?>
	...
	<?php if ($tparams->get('allow_vcard')) : ?>
		<div>
			<strong><?php echo \Joomla\CMS\Language\Text::_('COM_CONTACT_DOWNLOAD_INFORMATION_AS'); ?></strong>
			<a href="<?php echo \Joomla\CMS\Router\Route::_('index.php?option=com_contact&amp;view=contact&amp;id=' . $this->contact->id . '&amp;format=vcf'); ?>" class="qx-link-text">
			<?php echo \Joomla\CMS\Language\Text::_('COM_CONTACT_VCARD'); ?></a>
		</div>
	<?php endif; ?>
	</div>
</div>
