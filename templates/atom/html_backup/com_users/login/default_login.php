...
<div class="login<?php echo $this->pageclass_sfx; ?>">
	...
	<?php if ($this->params->get('login_image') != '') : ?>
		<img src="<?php echo $this->escape($this->params->get('login_image')); ?>" class="login-image" alt="<?php echo \Joomla\CMS\Language\Text::_('COM_USERS_LOGIN_IMAGE_ALT'); ?>" />
	<?php endif; ?>
	<?php if (($this->params->get('logindescription_show') == 1 && str_replace(' ', '', $this->params->get('login_description')) != '') || $this->params->get('login_image') != '') : ?>
		</div>
	<?php endif; ?>
	<form action="<?php echo \Joomla\CMS\Router\Route::_('index.php?option=com_users&task=user.login'); ?>" method="post" class="form-validate well qx-form-stacked">
		<fieldset class="qx-fieldset">
			...
			<div id="form-login-username" class="qx-margin">
				<div class="qx-form-controls">
					<label class="qx-form-label" ><?php echo \Joomla\CMS\Language\Text::_('JGLOBAL_USERNAME'); ?></label>
			...
			<div id="form-login-password" class="qx-margin">
				<div class="qx-form-controls">
					<label class="qx-form-label" ><?php echo \Joomla\CMS\Language\Text::_('JGLOBAL_PASSWORD'); ?></label>
			...
			<?php if (JPluginHelper::isEnabled('system', 'remember')) : ?>
				<div class="qx-margin">
					<div class="qx-form-controls">
						<label for="remember">
						<input id="remember" type="checkbox" name="remember" class="qx-checkbox" value="yes" /> <?php echo \Joomla\CMS\Language\Text::_('COM_USERS_LOGIN_REMEMBER_ME'); ?>
						</label>
					</div>
				</div>
			<?php endif; ?>
			<div class="qx-margin">
				<div class="qx-form-controls">
					<button type="submit" class="qx-button qx-button-primary">
						<?php echo \Joomla\CMS\Language\Text::_('JLOGIN'); ?>
					</button>
				</div>
			</div>
	...
	<ul class="qx-list qx-link-text">
		<li>
			<a href="<?php echo \Joomla\CMS\Router\Route::_('index.php?option=com_users&view=reset'); ?>">
				<?php echo \Joomla\CMS\Language\Text::_('COM_USERS_LOGIN_RESET'); ?>
			</a>
		</li>
		<li>
			<a href="<?php echo \Joomla\CMS\Router\Route::_('index.php?option=com_users&view=remind'); ?>">
				<?php echo \Joomla\CMS\Language\Text::_('COM_USERS_LOGIN_REMIND'); ?>
			</a>
		</li>
		...
		<?php if ($usersConfig->get('allowUserRegistration')) : ?>
			<li>
				<a href="<?php echo \Joomla\CMS\Router\Route::_('index.php?option=com_users&view=registration'); ?>">
					<?php echo \Joomla\CMS\Language\Text::_('COM_USERS_LOGIN_REGISTER'); ?>
				</a>
			</li>
		<?php endif; ?>
	</ul>
