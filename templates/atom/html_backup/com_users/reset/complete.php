...
<div class="reset-complete<?php echo $this->pageclass_sfx; ?>">
	...
	<?php endif; ?>
	<form action="<?php echo \Joomla\CMS\Router\Route::_('index.php?option=com_users&task=reset.complete'); ?>" method="post" class="form-validate form-horizontal well qx-form-stacked">
			...
			<fieldset class="qx-fieldset">
				...
				<div class="qx-margin">
					<div class="qx-form-controls">
						<label class="qx-form-label" ><?php echo \Joomla\CMS\Language\Text::_('COM_USERS_FIELD_RESET_PASSWORD1_LABEL'); ?></label>
