...
<?php foreach ($userFieldGroups as $groupTitle => $fields) : ?>
	...
	<?php if ($presentation_style == 'sliders') : ?>
		<li class="qx-card qx-card-default qx-card-body">
			<a class="qx-accordion-title qx-text-bold" href="#display-<?php echo $id; ?>"><?php echo JText::_('COM_CONTACT_USER_FIELDS'); ?></a>
				<div id="display-<?php echo $id; ?>" class="qx-accordion-content">	
