...
class QuixController extends BaseController
{
    ...
    public function display($cachable = false, $urlparams = false)
    {
        ...
        if ($view === 'page' && $layout === 'edit' && ! $this->checkEditId('com_quix.edit.page', $id)) {
            ...
            Factory::getApplication()->enqueueMessage(\Joomla\CMS\Language\Text::sprintf('JLIB_APPLICATION_ERROR_UNHELD_ID', $id), 'error');
            ...
            // Somehow the person just went to the form - we don't allow that.
            Factory::getApplication()->enqueueMessage(\Joomla\CMS\Language\Text::sprintf('JLIB_APPLICATION_ERROR_UNHELD_ID', $id), 'error');
            $this->setRedirect(\Joomla\CMS\Router\Route::_('index.php?option=com_quix&view=collections', false));
    ...
    public function elements(): void
    {
        ...
        // Get an instance of the generic articles model
        $model = \Joomla\CMS\MVC\Model\BaseDatabaseModel::getInstance('Elements', 'QuixModel', ['ignore_request' => true]);
    ...
    public function updateSchema(): bool
    {
        ...
        $this->setRedirect(\Joomla\CMS\Router\Route::_('index.php?option=com_quix&view=pages', true));
    ...
    public function clear_cache(): bool
    {
        try {
            ...
            if ($input->get('step', 1, 'int') === 1) {
                ...
                echo new JResponseJson('', \Joomla\CMS\Language\Text::_('Quix builder cache cleaned.'), false, false);
            } else {
