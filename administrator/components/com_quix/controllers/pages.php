...
class QuixControllerPages extends AdminController
{
    ...
    public function duplicate()
    {
        ...
        if (empty($pks)) {
            throw new \RuntimeException(\Joomla\CMS\Language\Text::_('COM_QUIX_ERROR_NO_PAGE_SELECTED'));
        }
        ...
        if ( ! $model->duplicate($pks)) {
            ...
            $this->setMessage(\Joomla\CMS\Language\Text::plural('COM_QUIX_N_PAGES_DUPLICATED', count($pks)));
        }
    ...
    public function resetHits()
    {
        ...
        if ( ! $model->resetHits($pks)) {
            ...
            $this->setMessage(\Joomla\CMS\Language\Text::plural('COM_QUIX_N_PAGES_HIT_RESETS', count($pks)));
        }
    ...
    {
        // Check for request forgeries
        JSession::checkToken() || jexit(\Joomla\CMS\Language\Text::_('JINVALID_TOKEN'));
        ...
        try {
            ...
            $this->setMessage(\Joomla\CMS\Language\Text::_('COM_QUIXNXT_CACHE_CLEARED'));
        } catch (Exception $e) {
            $this->setMessage(\Joomla\CMS\Language\Text::sprintf('COM_QUIXNXT_CACHE_CLEAR_ERROR', $e->getMessage()), 'error');
        }
