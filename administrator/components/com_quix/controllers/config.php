...
class QuixControllerConfig extends BaseController
{
    ...
    public function save()
    {
        ...
        if ( ! $form) {
            Factory::getApplication()->enqueueMessage(\Joomla\CMS\Language\Text::sprintf('COM_QUIX_FORM_COULD_NOT_LOAD', 'Config'), 'error');
        ...
        if ($data === false) {
            ...
            $this->setRedirect(\Joomla\CMS\Router\Route::_('index.php?option=com_quix&view=config', false));
    ...
    public function validateLicense()
    {
        ...
        // Verify the key
        try {
            $response = QuixHelperLicense::verifyApiKey($username, $key);
