...
class QuixControllerPage extends JControllerForm
{
    ...
    public function save($key = null, $urlVar = null)
    {
        ...
        if ( ! $model->save($validData)) {
            ...
            if ($task == 'save') {
                ...
                $this->setMessage(\Joomla\CMS\Language\Text::sprintf('JLIB_APPLICATION_ERROR_SAVE_FAILED', $model->getError()));
            ...
            if ($task == 'save') {
                ...
                $this->setMessage(\Joomla\CMS\Language\Text::_('COM_QUIX_SAVE_SUCCESS'));
    ...
    public function pageCreateAjax()
    {
        ...
        if ( ! $model->save(
            ...
            echo new JResponseJson(new Exception(\Joomla\CMS\Language\Text::sprintf('Failed to save. Error: %s', $model->getError())), $model->getError(), 1, true);
        } else {
            $id   = $model->getState('page.id');
