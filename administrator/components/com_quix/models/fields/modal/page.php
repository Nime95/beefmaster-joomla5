    ...
    protected function getInputJ3()
    {
        ...
        if ($allowClear && !$scriptClear) {
            ...
            $script[] = '		document.getElementById(id + "_name").value = "'
                .
                htmlspecialchars(\Joomla\CMS\Language\Text::_('COM_QUIX_SELECT_AN_PAGE', true),
                    ENT_COMPAT, 'UTF-8').'";';
        ...
        if (empty($title)) {
            $title = \Joomla\CMS\Language\Text::_('COM_QUIX_SELECT_AN_PAGE');
        }
        ...
        $html[] = '<a href="#modalPage'.$this->id
            ...
            .\Joomla\CMS\HTML\HTMLHelper::tooltipText('COM_QUIX_CHANGE_ARTPAGE').'">'
        ...
        if ($allowClear) {
            $html[] = '<button id="'.$this->id.'_clear" class="btn'.($value ? ''
                ...
                .\Joomla\CMS\Language\Text::_('JCLEAR').'</button>';
        }
        ...
        $html[] = \Joomla\CMS\HTML\HTMLHelper::_(
            ...
            [
                'url'    => $url,
                'title'  => \Joomla\CMS\Language\Text::_('COM_QUIX_CHANGE_ARTPAGE'),
                'width'  => '800px',
                'height' => '300px',
