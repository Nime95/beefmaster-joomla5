...
class JFormFieldModal_Collection extends JFormField
{
    ...
    protected function getInputJ3()
    {
        ...
        // Load language
        Factory::getLanguage()->load('com_quix', JPATH_ADMINISTRATOR);
        ...
        if ($allowClear && ! $scriptClear) {
            ...
            $script[] = '		document.getElementById(id + "_name").value = "'.
                        htmlspecialchars(\Joomla\CMS\Language\Text::_('COM_QUIX_SELECT_AN_COLLECTION', true), ENT_COMPAT, 'UTF-8').'";';
        ...
        if (empty($title)) {
            $title = \Joomla\CMS\Language\Text::_('COM_QUIX_SELECT_AN_COLLECTION');
        }
        ...
        $html[] = '<a href="#modalCollection'.$this->id.'" class="btn hasTooltip" role="button"  data-toggle="modal" title="'
                  .\Joomla\CMS\HTML\HTMLHelper::tooltipText('COM_QUIX_CHANGE_COLLECTION').'">'
                  .'<span class="icon-file"></span> '
                  .\Joomla\CMS\Language\Text::_('JSELECT').'</a>';

        // Clear article button
        if ($allowClear) {
            $html[] = '<button id="'.$this->id.'_clear" class="btn'.($value ? '' : ' hidden').'" onclick="return jClearCollection(\''.
                      $this->id.'\')"><span class="icon-remove"></span>'.\Joomla\CMS\Language\Text::_('JCLEAR').'</button>';
        }
        ...
        $html[] = \Joomla\CMS\HTML\HTMLHelper::_(
            ...
            array(
                'url'    => $url,
                'title'  => \Joomla\CMS\Language\Text::_('COM_QUIX_CHANGE_COLLECTION'),
                'width'  => '800px',
                'height' => '300px',
    ...
    protected function getInputJ4()
    {
        ...
        $html[] = '<button'
                 ...
                 .\Joomla\CMS\Language\Text::_('JSELECT')
                 .'</button>';
        // $html[] = '<a href="#modalCollection'.$this->id.'" class="btn hasTooltip" role="button"  data-toggle="modal" title="'
        //           .\Joomla\CMS\HTML\HTMLHelper::tooltipText('COM_QUIX_CHANGE_COLLECTION').'">'
        //           .'<span class="icon-file"></span> '
