	...
	protected function getInput()
	{
		...
		switch ($this->input_type)
		{
			...
			default:
				...
				{
					$options[] = \Joomla\CMS\HTML\HTMLHelper::_('select.option', $result->{$this->key_field}, $result->{$this->value_field});
				}
				...
				$html = \Joomla\CMS\HTML\HTMLHelper::_('select.genericlist', $options, $this->name, $input_options, 'value', 'text', $value, $this->id);
				break;
		}
