...
class QuixModelConfig extends JModelForm
{
  ...
  protected function populateState()
  {
    ...
    if (!$extensionId)
    {
      Factory::getApplication()->enqueueMessage(\Joomla\CMS\Language\Text::_('COM_QUIX_NO_EXTENSION_RECORD_FOUND'), 'warning');
    }
    ...
    if (!$update_site_id)
    {
      Factory::getApplication()->enqueueMessage(\Joomla\CMS\Language\Text::_('COM_QUIX_NO_UPDATE_SITE_FOUND'), 'error');
    }
  ...
  public function save(array $data)
  {
    ...
    {
      Factory::getApplication()->enqueueMessage(\Joomla\CMS\Language\Text::_('COM_QUIX_ERR_INVALID_UPDATE_INFO'), 'error');
