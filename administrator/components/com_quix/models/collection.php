...
class QuixModelCollection extends JModelAdmin
{
    ...
    protected function loadFormData()
    {
        ...
        $data = Factory::getApplication()->getUserState('com_quix.edit.collection.data', array());
    ...
    protected function canEditState($record)
    {
        ...
        return Factory::getUser()->authorise('core.edit.state', 'com_quix.collection.'.(int) $record->id);
    }
}
