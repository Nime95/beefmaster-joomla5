...
?>
<form action="<?php echo \Joomla\CMS\Router\Route::_('index.php?option=com_quix'); ?>" method="post" name="adminForm" id="message-form" class="form-validate form-horizontal">
