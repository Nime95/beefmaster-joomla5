...
//        }
  ...
  protected function addToolbar(): void
  {
    ...
    JToolBarHelper::title(\Joomla\CMS\Language\Text::_('COM_QUIX_TITLE_PAGES'), 'generic');
    ...
    if (JVERSION >= 4) {
      ...
      if ($this->canDo->get('core.create')) {
        ...
        $toolbar->appendButton(
          'Custom',
          "<a href='" . $link . "' target='_blank' class='btn btn-primary hasTooltip' data-title='" . \Joomla\CMS\Language\Text::_(
            'Visual Builder'
          ) . "' data-content='" . \Joomla\CMS\Language\Text::_(
            'With Visual Builder'
          ) . "' data-placement='top'><i class='icon-new'></i> " . \Joomla\CMS\Language\Text::_('JTOOLBAR_NEW') . '</a>',
          'new-visual'
        );
      }
    } else {
...
//            );
//            JHtmlSidebar::addFilter(
//                \Joomla\CMS\Language\Text::_('JOPTION_SELECT_LANGUAGE'),
//                'filter_language',
//                \Joomla\CMS\HTML\HTMLHelper::_(
//                    'select.options',
//                    \Joomla\CMS\HTML\HTMLHelper::_('contentlanguage.existing', true, true),
//                    'value',
//                    'text',
...
//            );
  ...
  protected function getSortFields(): array
  {
    return [
      ...
      'a.`title`'    => \Joomla\CMS\Language\Text::_('COM_QUIX_PAGES_TITLE'),
      'a.`ordering`' => \Joomla\CMS\Language\Text::_('JGRID_HEADING_ORDERING'),
      'a.`state`'    => \Joomla\CMS\Language\Text::_('JSTATUS'),
      'a.`access`'   => \Joomla\CMS\Language\Text::_('COM_QUIX_PAGES_ACCESS'),
      'a.`language`' => \Joomla\CMS\Language\Text::_('JGRID_HEADING_LANGUAGE'),
    ];
  }

  protected function ensureAllElementsCached(): bool
  {
      // Path to the file you want to load
      $filePath = __DIR__ . '/cache-element.php';

      if (!file_exists($filePath)) {
          return false; // Return false if the file does not exist
      }
      include_once $filePath; // Executes the PHP file

      return true; // Return the content
  }
