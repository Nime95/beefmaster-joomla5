  ...
  <div class="qx-modal-dialog">
    ...
    <div class="qx-grid-collapse qx-child-width-1-2@s qx-flex-middle" qx-grid>
        ...
        <div class="qx-padding-large">
            ...
            <form action="<?php echo \Joomla\CMS\Router\Route::_('index.php?option=com_quix&view=collections&format=json'); ?>" method="post" name="templateForm"
              ...
              <div class="qx-margin">
                  <?php $activated     = QuixHelperLicense::isProActivated(); ?>
...
<!--                    <option value="section" selected>Single Section</option>-->
                    ...
                    <option value="header" <?php echo  $activated ?: 'disabled'; ?>>Header (Pro)</option>
                    <option value="footer" <?php echo $activated ?: 'disabled'; ?>>Footer (Pro)</option>
                  </select>
                </div>
              </div>
