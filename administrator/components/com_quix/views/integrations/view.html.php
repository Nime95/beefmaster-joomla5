...
class QuixViewIntegrations extends JViewLegacy
{
	...
	{
        JToolBarHelper::title(\Joomla\CMS\Language\Text::_('COM_QUIX_TITLE_INTEGRATIONS_MANAGER'), 'generic');
		...
		// 	$toolbar->appendButton('Custom', "<a href='".$link ."' target='_blank' class='btn hasTooltip' data-title='".\Joomla\CMS\Language\Text::_('Visual Builder')."' data-content='".\Joomla\CMS\Language\Text::_('With Visual Builder')."' data-placement='bottom'>".\Joomla\CMS\Language\Text::_('JTOOLBAR_NEW_PAGE')."</a>", 'new');
		// }
        //
