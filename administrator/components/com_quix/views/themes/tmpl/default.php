...
if ($saveOrder) {
    ...
    \Joomla\CMS\HTML\HTMLHelper::_('sortablelist.sortable', 'pageList', 'adminForm', strtolower($listDirn), $saveOrderingUrl);
}
$sortFields = $this->getSortFields();

Factory::getDocument()->addStylesheet(QuixAppHelper::getQuixMediaUrl().'/assets/css/qxbs.css');
Factory::getDocument()->addStylesheet(QuixAppHelper::getQuixMediaUrl().'/assets/css/qxui.css');
// Factory::getDocument()->addStylesheet(QuixAppHelper::getQuixMediaUrl().'/assets/css/qxicon.css');
...
?>
<form
	action="<?php echo \Joomla\CMS\Router\Route::_('index.php?option=com_quix&view=themes'); ?>"
			...
			<div id="filter-bar" class="btn-toolbar">
				...
				<div class="btn-group pull-left">
					...
					<button class="btn hasTooltip" id="clear-search-button" type="button"
						title="<?php echo \Joomla\CMS\Language\Text::_('JSEARCH_FILTER_CLEAR'); ?>">
				...
				<div class="btn-group pull-right hidden-phone">
					...
					<select name="directionTable" id="directionTable" class="input-medium"
						...
						<option value=""><?php echo \Joomla\CMS\Language\Text::_('JFIELD_ORDERING_DESC'); ?>
						</option>
				...
				<div class="btn-group pull-right">
					...
					<select name="sortTable" id="sortTable" class="input-medium" onchange="Joomla.orderTable()">
						<option value=""><?php echo \Joomla\CMS\Language\Text::_('JGLOBAL_SORT_BY'); ?>
						</option>
				...
				<table class="table table-striped" id="pageList">
						...
						<tr>
							...
							<th width="1%" class="hidden-phone">
								<input type="checkbox" name="checkall-toggle" value=""
									title="<?php echo \Joomla\CMS\Language\Text::_('JGLOBAL_CHECK_ALL'); ?>"
					...
					<tbody>
						...
						<tr class="row<?php echo $i % 2; ?>">
							...
							<td class="center">
								<div class="btn-group">
									<?php echo \Joomla\CMS\HTML\HTMLHelper::_('jgrid.published', $item->state, $i, 'themes.', $canChange, 'cb'); ?>
                                    ...
                                    \Joomla\CMS\HTML\HTMLHelper::_('actionsdropdown.duplicate', 'cb' . $i, 'themes');
                                    \Joomla\CMS\HTML\HTMLHelper::_('actionsdropdown.archive', 'cb' . $i, 'themes');
                                    // Render dropdown list
                                    echo \Joomla\CMS\HTML\HTMLHelper::_('actionsdropdown.render', $this->escape($item->title));
                                    ?>
								</div>
							</td>
							<?php endif; ?>
							<td>
								...
								<?php echo \Joomla\CMS\HTML\HTMLHelper::_('jgrid.checkedout', $i, $item->editor, $item->checked_out_time, 'themes.', $canCheckin); ?>
								<?php endif; ?>
								<?php if ($canEdit) : ?>
								<?php
...
<?php
    $layoutData = [
        ...
        'params' => [
            ...
            'title' => \Joomla\CMS\Language\Text::_('Create new Theme'),
            'bodyHeight' => '70',
            'modalWidth' => '80',
            'height' => '600',
            'width' => '1280'
