...
\Joomla\CMS\HTML\HTMLHelper::_('script', 'administrator/components/com_quix/assets/script.js', array('version' => 'auto'));
?>
		...
		<div class="qx-col-6">
			<div class="qx-card qx-p-5">
				<div class="qx-card-body">
					...
					<form action="<?php echo \Joomla\CMS\Router\Route::_('index.php?option=com_quix&view=collections'); ?>" method="post"
