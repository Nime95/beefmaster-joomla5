...
<form
  action="<?php echo \Joomla\CMS\Router\Route::_('index.php?option=com_quix&view=page&layout=edit&id=' . $this->item->id); ?>"
      ...
      <div class="row">
        <div class="col s12">
          <ul class="qx-appbar__navs tabs">
            <li class="tab"><a href="#layout" class="active"><?php echo \Joomla\CMS\Language\Text::_('COM_QUIX_TITLE_PAGE_LAYOUT'); ?></a>
            </li>
            <li class="tab"><a href="#metadata"><?php echo \Joomla\CMS\Language\Text::_('COM_QUIX_FORM_LBL_PAGE_METADATA'); ?></a>
            </li>
            <li class="tab"><a href="#params"><?php echo \Joomla\CMS\Language\Text::_('COM_QUIX_FORM_LBL_PAGE_PARAMS'); ?></a>
            </li>
            <li class="tab hide"><a href="#permissions"><?php echo \Joomla\CMS\Language\Text::_('COM_QUIX_FORM_LBL_PAGE_PERMISSIONS'); ?></a>
            </li>
            <li class="tab"><a href="#advance"><?php echo \Joomla\CMS\Language\Text::_('COM_QUIX_FORM_LBL_PAGE_ADVANCE'); ?></a>
            </li>
          </ul>
                  ...
                  <span class="spacer">
                    <span class="text">
                      <label id="jform_params_paramspacer-lbl" class="">
                        <?php echo \Joomla\CMS\Language\Text::_('COM_QUIX_FORM_LBL_PAGE_PARAM_SPACER_TITLE');?>
                      </label>
                    </span>
                  </span>
                </div>
