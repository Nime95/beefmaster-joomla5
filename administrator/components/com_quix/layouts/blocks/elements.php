...
<div class="alert clearfix">
	<a target="_blank" href="https://www.themexpert.com/quix-pagebuilder?utm_medium=button&utm_campaign=quix-pro&utm_source=joomla-admin" class="btn btn-danger pull-right" style="margin-top: 20px;">
	    <?php echo \Joomla\CMS\Language\Text::_('COM_QUIX_GET_PRO_TITLE'); ?>
  	</a>
	<h4 class="alert-heading">
		<?php echo \Joomla\CMS\Language\Text::_('COM_QUIX_FREE_NOTICE_TITLE'); ?>
	</h4>
	<p style="line-height: 1.4;">
		<?php echo \Joomla\CMS\Language\Text::_('COM_QUIX_FREE_NOTICE_DESC'); ?>
	</p>
</div>
<p>
	<img
