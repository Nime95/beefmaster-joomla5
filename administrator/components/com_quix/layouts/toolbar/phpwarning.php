...
<div class="qx-box-shadow-small qx-box-shadow-hover-medium qx-alert qx-alert-danger clearfix qx-alert qx-margin-remove" qx-alert>
  <div class=" qx-container">
    ...
    <p>
      ...
      <strong><?php echo \Joomla\CMS\Language\Text::_('COM_QUIX_HEADS_UP_OLD_PHP'); ?></strong> <?php echo \Joomla\CMS\Language\Text::sprintf('COM_QUIX_PHP_WARNING_OLD_VERSIONS', phpversion()); ?>
    </p>
  </div>
</div>
