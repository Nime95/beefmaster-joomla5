	...
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">	
				<span class="tammano-18"><?php echo Text::_('COM_SECURITYCHECKPRO_AKEEBA_RESTORATION_FILES_INFO'); ?></span><br/><br/>	
			</div>
													...
													<div class="modal hide bd-example-modal-lg" id="modal_vuln_extensions" tabindex="-1" role="dialog" aria-labelledby="modal_vuln_extensionsLabel" aria-hidden="true">
														  <div class="modal-dialog modal-lg" role="document">
															<div class="modal-content">
															  ...
															  <div class="modal-body">	
																<span class="tammano-18"><?php echo Text::_('COM_SECURITYCHECKPRO_VULN_EXTENSIONS_INFO'); ?></span><br/><br/>	
															  </div>
																<div class="modal-footer">
																	<button class="btn" <?php echo $data;?>dismiss="modal" aria-hidden="true"><?php echo Text::_( 'COM_SECURITYCHECKPRO_CLOSE' ); ?></button>
																</div>			  
															</div>
														  </div>
														</div>
													...
													<div class="modal hide bd-example-modal-lg" id="modal_malware_found" tabindex="-1" role="dialog" aria-labelledby="modal_malware_foundLabel" aria-hidden="true">
														  <div class="modal-dialog modal-lg" role="document">
															<div class="modal-content">
															  ...
															  <div class="modal-body">	
																<span class="tammano-18"><?php echo Text::_('COM_SECURITYCHECKPRO_MALWARE_FOUND_INFO'); ?></span><br/><br/>	
															  </div>
																<div class="modal-footer">
																	<button class="btn" <?php echo $data;?>dismiss="modal" aria-hidden="true"><?php echo Text::_( 'COM_SECURITYCHECKPRO_CLOSE' ); ?></button>
																</div>			  
													...
													<div class="modal hide bd-example-modal-lg" id="modal_files_with_bad_integrity" tabindex="-1" role="dialog" aria-labelledby="modal_files_with_bad_integrityLabel" aria-hidden="true">
														  <div class="modal-dialog modal-lg" role="document">
															<div class="modal-content">
															  ...
															  <div class="modal-body">	
																<span class="tammano-18"><?php echo Text::_('COM_SECURITYCHECKPRO_FILES_BAD_INTEGRITY_INFO'); ?></span><br/><br/>	
															  </div>
																<div class="modal-footer">
																	<button class="btn" <?php echo $data;?>dismiss="modal" aria-hidden="true"><?php echo Text::_( 'COM_SECURITYCHECKPRO_CLOSE' ); ?></button>
																</div>			  
													...
													<div class="modal hide bd-example-modal-lg" id="modal_file_permissions" tabindex="-1" role="dialog" aria-labelledby="modal_file_permissionsLabel" aria-hidden="true">
														  <div class="modal-dialog modal-lg" role="document">
															<div class="modal-content">
															  ...
															  <div class="modal-body">	
																<span class="tammano-18"><?php echo Text::_('COM_SECURITYCHECKPRO_FILE_PERMISSIONS_INFO'); ?></span><br/><br/>	
															  </div>
																<div class="modal-footer">
																	<button class="btn" <?php echo $data;?>dismiss="modal" aria-hidden="true"><?php echo Text::_( 'COM_SECURITYCHECKPRO_CLOSE' ); ?></button>
																</div>			  
													...
													<div class="modal hide bd-example-modal-lg" id="modal_hide_backend" tabindex="-1" role="dialog" aria-labelledby="modal_hide_backendLabel" aria-hidden="true">
														  <div class="modal-dialog modal-lg" role="document">
															<div class="modal-content">
															  ...
															  <div class="modal-body">	
																<span class="tammano-18"><?php echo Text::_('COM_SECURITYCHECKPRO_HIDE_BACKEND_INFO'); ?></span><br/><br/>	
															  </div>
																<div class="modal-footer">
																	<button class="btn" <?php echo $data;?>dismiss="modal" aria-hidden="true"><?php echo Text::_( 'COM_SECURITYCHECKPRO_CLOSE' ); ?></button>
																</div>			  
													...
													<div class="modal hide bd-example-modal-lg" id="modal_forbid_new_admins" tabindex="-1" role="dialog" aria-labelledby="modal_forbid_new_adminsLabel" aria-hidden="true">
														  <div class="modal-dialog modal-lg" role="document">
															<div class="modal-content">
															  ...
															  <div class="modal-body">	
																<span class="tammano-18"><?php echo Text::_('COM_SECURITYCHECKPRO_FORBID_NEW_ADMINS_LABEL_INFO'); ?></span><br/><br/>	
															  </div>
																<div class="modal-footer">
																	<button class="btn" <?php echo $data;?>dismiss="modal" aria-hidden="true"><?php echo Text::_( 'COM_SECURITYCHECKPRO_CLOSE' ); ?></button>
																</div>			  
													...
													<div class="modal hide bd-example-modal-lg" id="modal_two_factor_enabled" tabindex="-1" role="dialog" aria-labelledby="modal_two_factor_enabledLabel" aria-hidden="true">
														  <div class="modal-dialog modal-lg" role="document">
															<div class="modal-content">
															  ...
															  <div class="modal-body">	
																<span class="tammano-18"><?php echo Text::_('COM_SECURITYCHECKPRO_TWO_FACTOR_ENABLED_LABEL_INFO'); ?></span><br/><br/>	
															  </div>
																<div class="modal-footer">
																	<button class="btn" <?php echo $data;?>dismiss="modal" aria-hidden="true"><?php echo Text::_( 'COM_SECURITYCHECKPRO_CLOSE' ); ?></button>
																</div>			  
													...
													<div class="modal hide bd-example-modal-lg" id="modal_firewall_plugin_enabled" tabindex="-1" role="dialog" aria-labelledby="modal_firewall_plugin_enabledLabel" aria-hidden="true">
														  <div class="modal-dialog modal-lg" role="document">
															<div class="modal-content">
															  ...
															  <div class="modal-body">	
																<span class="tammano-18"><?php echo Text::_('COM_SECURITYCHECKPRO_FIREWALL_ENABLED_INFO'); ?></span><br/><br/>	
															  </div>
																<div class="modal-footer">
																	<button class="btn" <?php echo $data;?>dismiss="modal" aria-hidden="true"><?php echo Text::_( 'COM_SECURITYCHECKPRO_CLOSE' ); ?></button>
																</div>			  
													...
													<div class="modal hide bd-example-modal-lg" id="modal_logs_attacks" tabindex="-1" role="dialog" aria-labelledby="modal_logs_attacksLabel" aria-hidden="true">
														  <div class="modal-dialog modal-lg" role="document">
															<div class="modal-content">
															  ...
															  <div class="modal-body">	
																<span class="tammano-18"><?php echo Text::_('COM_SECURITYCHECKPRO_LOG_ATTACKS_INFO'); ?></span><br/><br/>	
															  </div>
																<div class="modal-footer">
																	<button class="btn" <?php echo $data;?>dismiss="modal" aria-hidden="true"><?php echo Text::_( 'COM_SECURITYCHECKPRO_CLOSE' ); ?></button>
																</div>			  
													...
													<div class="modal hide bd-example-modal-lg" id="modal_second_level" tabindex="-1" role="dialog" aria-labelledby="modal_second_levelLabel" aria-hidden="true">
														  <div class="modal-dialog modal-lg" role="document">
															<div class="modal-content">
															  ...
															  <div class="modal-body">	
																<span class="tammano-18"><?php echo Text::_('COM_SECURITYCHECKPRO_SECOND_LEVEL_INFO'); ?></span><br/><br/>	
															  </div>
																<div class="modal-footer">
																	<button class="btn" <?php echo $data;?>dismiss="modal" aria-hidden="true"><?php echo Text::_( 'COM_SECURITYCHECKPRO_CLOSE' ); ?></button>
																</div>			  
													...
													<div class="modal hide bd-example-modal-lg" id="modal_exclude_exceptions_if_vulnerable" tabindex="-1" role="dialog" aria-labelledby="modal_second_levelLabel" aria-hidden="true">
														  <div class="modal-dialog modal-lg" role="document">
															<div class="modal-content">
															  ...
															  <div class="modal-body">	
																<span class="tammano-18"><?php echo Text::_('COM_SECURITYCHECKPRO_EXCLUDE_EXCEPTIONS_IF_VULNERABLE_DESCRIPTION'); ?></span><br/><br/>	
															  </div>
																<div class="modal-footer">
																	<button class="btn" <?php echo $data;?>dismiss="modal" aria-hidden="true"><?php echo Text::_( 'COM_SECURITYCHECKPRO_CLOSE' ); ?></button>
																</div>			  
													...
													<div class="modal hide bd-example-modal-lg" id="modal_strip_tags_exceptions" tabindex="-1" role="dialog" aria-labelledby="modal_strip_tags_exceptionsLabel" aria-hidden="true">
														  <div class="modal-dialog modal-lg" role="document">
															<div class="modal-content">
															  ...
															  <div class="modal-body">	
																<span class="tammano-18"><?php echo Text::_('COM_SECURITYCHECKPRO_XSS_FILTER_INFO'); ?></span><br/><br/>	
															  </div>
																<div class="modal-footer">
																	<button class="btn" <?php echo $data;?>dismiss="modal" aria-hidden="true"><?php echo Text::_( 'COM_SECURITYCHECKPRO_CLOSE' ); ?></button>
																</div>			  
													...
													<div class="modal hide bd-example-modal-lg" id="modal_sql_pattern_exceptions" tabindex="-1" role="dialog" aria-labelledby="modal_sql_pattern_exceptionsLabel" aria-hidden="true">
														  <div class="modal-dialog modal-lg" role="document">
															<div class="modal-content">
															  ...
															  <div class="modal-body">	
																<span class="tammano-18"><?php echo Text::_('COM_SECURITYCHECKPRO_SQL_FILTER_INFO'); ?></span><br/><br/>	
															  </div>
																<div class="modal-footer">
																	<button class="btn" <?php echo $data;?>dismiss="modal" aria-hidden="true"><?php echo Text::_( 'COM_SECURITYCHECKPRO_CLOSE' ); ?></button>
																</div>			  
													...
													<div class="modal hide bd-example-modal-lg" id="modal_session_protection_active" tabindex="-1" role="dialog" aria-labelledby="modal_session_protection_activeLabel" aria-hidden="true">
														  <div class="modal-dialog modal-lg" role="document">
															<div class="modal-content">
															  ...
															  <div class="modal-body">	
																<span class="tammano-18"><?php echo Text::_('COM_SECURITYCHECKPRO_SESSION_PROTECTION_INFO'); ?></span><br/><br/>	
															  </div>
																<div class="modal-footer">
																	<button class="btn" <?php echo $data;?>dismiss="modal" aria-hidden="true"><?php echo Text::_( 'COM_SECURITYCHECKPRO_CLOSE' ); ?></button>
																</div>			  
													...
													<div class="modal hide bd-example-modal-lg" id="modal_session_hijack_protection" tabindex="-1" role="dialog" aria-labelledby="modal_session_hijack_protectionLabel" aria-hidden="true">
														  <div class="modal-dialog modal-lg" role="document">
															<div class="modal-content">
															  ...
															  <div class="modal-body">	
																<span class="tammano-18"><?php echo Text::_('COM_SECURITYCHECKPRO_SESSION_HIJACK_PROTECTION_INFO'); ?></span><br/><br/>	
															  </div>
																<div class="modal-footer">
																	<button class="btn" <?php echo $data;?>dismiss="modal" aria-hidden="true"><?php echo Text::_( 'COM_SECURITYCHECKPRO_CLOSE' ); ?></button>
																</div>			  
													...
													<div class="modal hide bd-example-modal-lg" id="modal_upload_scanner_enabled" tabindex="-1" role="dialog" aria-labelledby="modal_upload_scanner_enabledLabel" aria-hidden="true">
														  <div class="modal-dialog modal-lg" role="document">
															<div class="modal-content">
															  ...
															  <div class="modal-body">	
																<span class="tammano-18"><?php echo Text::_('COM_SECURITYCHECKPRO_UPLOADSCANNER_DESCRIPTION'); ?></span><br/><br/>	
															  </div>
																<div class="modal-footer">
																	<button class="btn" <?php echo $data;?>dismiss="modal" aria-hidden="true"><?php echo Text::_( 'COM_SECURITYCHECKPRO_CLOSE' ); ?></button>
																</div>			  
													...
													<div class="modal hide bd-example-modal-lg" id="modal_cron_enabled" tabindex="-1" role="dialog" aria-labelledby="modal_cron_enabledLabel" aria-hidden="true">
														  <div class="modal-dialog modal-lg" role="document">
															<div class="modal-content">
															  ...
															  <div class="modal-body">	
																<span class="tammano-18"><?php echo Text::_('COM_SECURITYCHECKPRO_CRON_ENABLED_INFO'); ?></span><br/><br/>	
															  </div>
																<div class="modal-footer">
																	<button class="btn" <?php echo $data;?>dismiss="modal" aria-hidden="true"><?php echo Text::_( 'COM_SECURITYCHECKPRO_CLOSE' ); ?></button>
																</div>			  
													...
													<div class="modal hide bd-example-modal-lg" id="modal_last_check" tabindex="-1" role="dialog" aria-labelledby="modal_last_checkLabel" aria-hidden="true">
														  <div class="modal-dialog modal-lg" role="document">
															<div class="modal-content">
															  ...
															  <div class="modal-body">	
																<span class="tammano-18"><?php echo Text::_('COM_SECURITYCHECKPRO_LAST_CHECK_INFO'); ?></span><br/><br/>	
															  </div>
																<div class="modal-footer">
																	<button class="btn" <?php echo $data;?>dismiss="modal" aria-hidden="true"><?php echo Text::_( 'COM_SECURITYCHECKPRO_CLOSE' ); ?></button>
																</div>			  
													...
													<div class="modal hide bd-example-modal-lg" id="modal_last_check_integrity" tabindex="-1" role="dialog" aria-labelledby="modal_last_check_integrityLabel" aria-hidden="true">
														  <div class="modal-dialog modal-lg" role="document">
															<div class="modal-content">
															  ...
															  <div class="modal-body">	
																<span class="tammano-18"><?php echo Text::_('COM_SECURITYCHECKPRO_LAST_CHECK_INTEGRITY_INFO'); ?></span><br/><br/>	
															  </div>
																<div class="modal-footer">
																	<button class="btn" <?php echo $data;?>dismiss="modal" aria-hidden="true"><?php echo Text::_( 'COM_SECURITYCHECKPRO_CLOSE' ); ?></button>
																</div>			  
													...
													<div class="modal hide bd-example-modal-lg" id="modal_prevent_access" tabindex="-1" role="dialog" aria-labelledby="modal_prevent_accessLabel" aria-hidden="true">
														  <div class="modal-dialog modal-lg" role="document">
															<div class="modal-content">
															  ...
															  <div class="modal-body">	
																<span class="tammano-18"><?php echo Text::_('COM_SECURITYCHECKPRO_PREVENT_ACCESS_EXPLAIN'); ?></span><br/><br/>	
															  </div>
																<div class="modal-footer">
																	<button class="btn" <?php echo $data;?>dismiss="modal" aria-hidden="true"><?php echo Text::_( 'COM_SECURITYCHECKPRO_CLOSE' ); ?></button>
																</div>			  
													...
													<div class="modal hide bd-example-modal-lg" id="modal_prevent_unauthorized_browsing" tabindex="-1" role="dialog" aria-labelledby="modal_prevent_unauthorized_browsingLabel" aria-hidden="true">
														  <div class="modal-dialog modal-lg" role="document">
															<div class="modal-content">
															  ...
															  <div class="modal-body">	
																<span class="tammano-18"><?php echo Text::_('COM_SECURITYCHECKPRO_PREVENT_UNAUTHORIZED_BROWSING_EXPLAIN'); ?></span><br/><br/>	
															  </div>
																<div class="modal-footer">
																	<button class="btn" <?php echo $data;?>dismiss="modal" aria-hidden="true"><?php echo Text::_( 'COM_SECURITYCHECKPRO_CLOSE' ); ?></button>
																</div>			  
													...
													<div class="modal hide bd-example-modal-lg" id="modal_file_injection_protection" tabindex="-1" role="dialog" aria-labelledby="modal_file_injection_protectionLabel" aria-hidden="true">
														  <div class="modal-dialog modal-lg" role="document">
															<div class="modal-content">
															  ...
															  <div class="modal-body">	
																<span class="tammano-18"><?php echo Text::_('COM_SECURITYCHECKPRO_FILE_INJECTION_PROTECTION_EXPLAIN'); ?></span><br/><br/>	
															  </div>
																<div class="modal-footer">
																	<button class="btn" <?php echo $data;?>dismiss="modal" aria-hidden="true"><?php echo Text::_( 'COM_SECURITYCHECKPRO_CLOSE' ); ?></button>
																</div>			  
													...
													<div class="modal hide bd-example-modal-lg" id="modal_self_environ" tabindex="-1" role="dialog" aria-labelledby="modal_self_environLabel" aria-hidden="true">
														  <div class="modal-dialog modal-lg" role="document">
															<div class="modal-content">
															  ...
															  <div class="modal-body">	
																<span class="tammano-18"><?php echo Text::_('COM_SECURITYCHECKPRO_SELF_ENVIRON_EXPLAIN'); ?></span><br/><br/>	
															  </div>
																<div class="modal-footer">
																	<button class="btn" <?php echo $data;?>dismiss="modal" aria-hidden="true"><?php echo Text::_( 'COM_SECURITYCHECKPRO_CLOSE' ); ?></button>
																</div>			  
													...
													<div class="modal hide bd-example-modal-lg" id="modal_xframe_options" tabindex="-1" role="dialog" aria-labelledby="modal_xframe_optionsLabel" aria-hidden="true">
														  <div class="modal-dialog modal-lg" role="document">
															<div class="modal-content">
															  ...
															  <div class="modal-body">	
																<span class="tammano-18"><?php echo Text::_('COM_SECURITYCHECKPRO_XFRAME_OPTIONS_EXPLAIN'); ?></span><br/><br/>	
															  </div>
																<div class="modal-footer">
																	<button class="btn" <?php echo $data;?>dismiss="modal" aria-hidden="true"><?php echo Text::_( 'COM_SECURITYCHECKPRO_CLOSE' ); ?></button>
																</div>			  
													...
													<div class="modal hide bd-example-modal-lg" id="modal_prevent_mime_attacks" tabindex="-1" role="dialog" aria-labelledby="modal_prevent_mime_attacksLabel" aria-hidden="true">
														  <div class="modal-dialog modal-lg" role="document">
															<div class="modal-content">
															  ...
															  <div class="modal-body">	
																<span class="tammano-18"><?php echo Text::_('COM_SECURITYCHECKPRO_PREVENT_MIME_ATTACKS_EXPLAIN'); ?></span><br/><br/>	
															  </div>
																<div class="modal-footer">
																	<button class="btn" <?php echo $data;?>dismiss="modal" aria-hidden="true"><?php echo Text::_( 'COM_SECURITYCHECKPRO_CLOSE' ); ?></button>
																</div>			  
													...
													<div class="modal hide bd-example-modal-lg" id="modal_default_banned_list" tabindex="-1" role="dialog" aria-labelledby="modal_default_banned_listLabel" aria-hidden="true">
														  <div class="modal-dialog modal-lg" role="document">
															<div class="modal-content">
															  ...
															  <div class="modal-body">	
																<span class="tammano-18"><?php echo Text::_('COM_SECURITYCHECKPRO_DEFAULT_BANNED_LIST_INFO'); ?></span><br/><br/>	
															  </div>
																<div class="modal-footer">
																	<button class="btn" <?php echo $data;?>dismiss="modal" aria-hidden="true"><?php echo Text::_( 'COM_SECURITYCHECKPRO_CLOSE' ); ?></button>
																</div>			  
													...
													<div class="modal hide bd-example-modal-lg" id="modal_disable_server_signature" tabindex="-1" role="dialog" aria-labelledby="modal_disable_server_signatureLabel" aria-hidden="true">
														  <div class="modal-dialog modal-lg" role="document">
															<div class="modal-content">
															  ...
															  <div class="modal-body">	
																<span class="tammano-18"><?php echo Text::_('COM_SECURITYCHECKPRO_DISABLE_SERVER_SIGNATURE_EXPLAIN'); ?></span><br/><br/>	
															  </div>
																<div class="modal-footer">
																	<button class="btn" <?php echo $data;?>dismiss="modal" aria-hidden="true"><?php echo Text::_( 'COM_SECURITYCHECKPRO_CLOSE' ); ?></button>
																</div>			  
													...
													<div class="modal hide bd-example-modal-lg" id="modal_disallow_php_eggs" tabindex="-1" role="dialog" aria-labelledby="modal_disallow_php_eggsLabel" aria-hidden="true">
														  <div class="modal-dialog modal-lg" role="document">
															<div class="modal-content">
															  ...
															  <div class="modal-body">	
																<span class="tammano-18"><?php echo Text::_('COM_SECURITYCHECKPRO_DISALLOW_PHP_EGGS_EXPLAIN'); ?></span><br/><br/>	
															  </div>
																<div class="modal-footer">
																	<button class="btn" <?php echo $data;?>dismiss="modal" aria-hidden="true"><?php echo Text::_( 'COM_SECURITYCHECKPRO_CLOSE' ); ?></button>
																</div>			  
													...
													<div class="modal hide bd-example-modal-lg" id="modal_disallow_sensible_files_access" tabindex="-1" role="dialog" aria-labelledby="modal_disallow_sensible_files_accessLabel" aria-hidden="true">
														  <div class="modal-dialog modal-lg" role="document">
															<div class="modal-content">
															  ...
															  <div class="modal-body">	
																<span class="tammano-18"><?php echo Text::_('COM_SECURITYCHECKPRO_DISALLOW_ACCESS_SENSIBLE_FILES_INFO'); ?></span><br/><br/>	
															  </div>
																<div class="modal-footer">
																	<button class="btn" <?php echo $data;?>dismiss="modal" aria-hidden="true"><?php echo Text::_( 'COM_SECURITYCHECKPRO_CLOSE' ); ?></button>
																</div>			  
...
<form action="<?php echo Route::_('index.php?option=com_securitycheck&view=sysinfo&'. Session::getFormToken() .'=1');?>" method="post" name="adminForm" id="adminForm">

		<div class="card mb-3" style="margin-left: 10px;">
			<div class="card-header">
				<i class="fa fa-table"></i>
					<?php echo Text::_( 'COM_SECURITYCHECK_SYSTEM_INFORMATION' ); ?>
			</div>
			<div class="card-body">
									
				<ul class="nav nav-tabs" role="tablist" id="sysinfoTab">
					<li class="nav-item">
						<a class="nav-link active" <?php echo $data;?>toggle="tab" href="#overall_status" role="tab"><?php echo Text::_('COM_SECURITYCHECKPRO_SECURITY_OVERALL_STATUS'); ?></a>
					</li>
					<li class="nav-item">
						<a class="nav-link" <?php echo $data;?>toggle="tab" href="#extension_status" role="tab"><?php echo Text::_('COM_SECURITYCHECKPRO_EXTENSION_STATUS'); ?></a>
					</li>
					<li class="nav-item">
						<a class="nav-link" <?php echo $data;?>toggle="tab" href="#global_configuration" role="tab"><?php echo Text::_('COM_SECURITYCHECK_GLOBAL_CONFIGURATION'); ?></a>
					</li>
					<li class="nav-item">
						<a class="nav-link" <?php echo $data;?>toggle="tab" href="#mysql_configuration" role="tab"><?php echo Text::_('COM_SECURITYCHECK_MYSQL_CONFIGURATION'); ?></a>
					</li>
					<li class="nav-item">
						<a class="nav-link" <?php echo $data;?>toggle="tab" href="#php_configuration" role="tab"><?php echo Text::_('COM_SECURITYCHECK_PHP_CONFIGURATION'); ?></a>
					</li>
				</ul>
				...
				<div class="tab-content">
								...
								<div class="card-body">
									...
									<div class="row">
											...
											<li class="list-group-item">
												<?php 
													if ( $this->system_info['kickstart_exists'] ) {
														$span = "<span class=\"badge " . $badge_style . "danger\">" . Text::_("COM_SECURITYCHECKPRO_YES");
													} else {								
														$span = "<span class=\"badge " . $badge_style . "success\">" . Text::_("COM_SECURITYCHECKPRO_NO");
													}
												?>						
												</span>
												<div>							
													<?php 
														if ( !$this->system_info['kickstart_exists'] ) {
															echo "<span class=\"badge " . $badge_style . "success\">OK</span>";
														} else {
															echo "<span class=\"badge " . $badge_style . "danger\">" . Text::sprintf( 'COM_SECURITYCHECKPRO_SECURITY_PROBLEM_FOUND',1 ) . "</span>";
													?>													
											...
											<li class="list-group-item">
												<?php 
													if ( version_compare($this->system_info['coreinstalled'],$this->system_info['corelatest'],'==') ) {
														$span = "<span class=\"badge" . $badge_style . "success\">";
													} else {
														$span = "<span class=\"badge " . $badge_style . "danger\">";
													}
												?>
												...
												<div>							
													<?php 
														if ( version_compare($this->system_info['coreinstalled'],$this->system_info['corelatest'],'==') ) {
															...
															echo "<span class=\"badge " . $badge_style . "danger\">" . Text::sprintf( 'COM_SECURITYCHECKPRO_SECURITY_PROBLEM_FOUND',1 ) . "</span>";
													?>
														<button class="btn btn-info btn-sm" type="button" onclick="GoToJoomlaUpdate();"><i class="icon-wrench icon-white"></i></button>
													<?php }	?>														
												</div>							
											</li>
										</ul>
											...
											<li class="list-group-item">
												<?php 
													if ( $this->system_info['vuln_extensions'] == 0 ) {
														...
														echo "<span class=\"badge " . $badge_style . "danger\">" . Text::sprintf( 'COM_SECURITYCHECKPRO_SECURITY_PROBLEM_FOUND',$this->system_info['vuln_extensions'] ) . "</span>";
												?>
													<button class="btn btn-info btn-sm" type="button" onclick="Joomla.submitbutton('GoToVuln')" href="#"><i class="icon-wrench icon-white"></i></button>													
													<a href="#modal_vuln_extensions" role="button" class="btn btn-secondary btn-sm" <?php echo $data;?>toggle="modal"><?php echo Text::_( 'COM_SECURITYCHECKPRO_MORE_INFO' ); ?></a>
												<?php }	?>							
											</li>
										</ul>
										</div>
										...
										<ul class="list-group">
											...
											<li class="list-group-item">
												<?php 
													echo "<span class=\"badge " . $badge_style . "info\">" . Text::_('COM_SECURITYCHECK_AVAILABLE_ONLY_PRO_VERSIONS') . "</span>";
												?>
																							
													<a href="#modal_malware_found" role="button" class="btn btn-secondary btn-sm" <?php echo $data;?>toggle="modal"><?php echo Text::_( 'COM_SECURITYCHECKPRO_MORE_INFO' ); ?></a>																			
											</li>
										</ul>
										</div>
										...
										<ul class="list-group">
											...
											<li class="list-group-item">
												<?php 
													echo "<span class=\"badge " . $badge_style . "info\">" . Text::_('COM_SECURITYCHECK_AVAILABLE_ONLY_PRO_VERSIONS') . "</span>";
												?>																							
													<a href="#modal_files_with_bad_integrity" role="button" class="btn btn-secondary btn-sm" <?php echo $data;?>toggle="modal"><?php echo Text::_( 'COM_SECURITYCHECKPRO_MORE_INFO' ); ?></a>																		
											</li>
										</ul>
										</div>
											...
											<li class="list-group-item">
												<?php 
													if ( $this->system_info['files_with_incorrect_permissions'] == 0 ) {
														...
														echo "<span class=\"badge " . $badge_style . "danger\">" . Text::sprintf( 'COM_SECURITYCHECKPRO_SECURITY_PROBLEM_FOUND',$this->system_info['files_with_incorrect_permissions'] ) . "</span>";
												?>
													<button class="btn btn-info btn-sm" type="button" onclick="Joomla.submitbutton('GoToPermissions')" href="#"><i class="icon-wrench icon-white"></i></button>																								
													<a href="#modal_file_permissions" role="button" class="btn btn-secondary btn-sm" <?php echo $data;?>toggle="modal"><?php echo Text::_( 'COM_SECURITYCHECKPRO_MORE_INFO' ); ?></a>
												<?php }	?>							
											</li>
										</ul>
										</div>
											...
											<li class="list-group-item">
												<?php 
													if ( $this->system_info['backend_protection'] ) {
														...
														echo "<span class=\"badge " . $badge_style . "danger\">" . Text::sprintf( 'COM_SECURITYCHECKPRO_SECURITY_PROBLEM_FOUND',1 ) . "</span>";
												?>
													<button class="btn btn-info btn-sm" type="button" onclick="Joomla.submitbutton('GoToHtaccessProtection')" href="#"><i class="icon-wrench icon-white"></i></button>																							
													<a href="#modal_hide_backend" role="button" class="btn btn-secondary btn-sm" <?php echo $data;?>toggle="modal"><?php echo Text::_( 'COM_SECURITYCHECKPRO_MORE_INFO' ); ?></a>
												<?php }	?>							
											</li>
										</ul>
										</div>
										...
										<ul class="list-group">
											...
											<li class="list-group-item">
												<?php 
													echo "<span class=\"badge " . $badge_style . "info\">" . Text::_('COM_SECURITYCHECK_AVAILABLE_ONLY_PRO_VERSIONS') . "</span>";
												?>																						
													<a href="#modal_forbid_new_admins" role="button" class="btn btn-secondary btn-sm" <?php echo $data;?>toggle="modal"><?php echo Text::_( 'COM_SECURITYCHECKPRO_MORE_INFO' ); ?></a>																		
											</li>
										</ul>
										</div>
											...
											<li class="list-group-item">
												<?php 
													if ( $this->system_info['twofactor_enabled'] == 1 ) {
														...
														echo "<span class=\"badge " . $badge_style . "danger\">" . Text::sprintf( 'COM_SECURITYCHECKPRO_SECURITY_PROBLEM_FOUND',1 ) . "</span>";
												?>
													<button class="btn btn-info btn-sm" type="button" onclick="GoToJoomlaPlugins();" href="#"><i class="icon-wrench icon-white"></i></button>																							
													<a href="#modal_two_factor_enabled" role="button" class="btn btn-secondary btn-sm" <?php echo $data;?>toggle="modal"><?php echo Text::_( 'COM_SECURITYCHECKPRO_MORE_INFO' ); ?></a>
												<?php }	?>							
											</li>
										</ul>
										</div>
									...
									<div class="row">
											...
											<li class="list-group-item">
												<?php 
													if ( $this->system_info['firewall_plugin_enabled'] ) {
														...
														echo "<span class=\"badge " . $badge_style . "danger\">" . Text::sprintf( 'COM_SECURITYCHECKPRO_SECURITY_PROBLEM_FOUND',1 ) . "</span>";
												?>
													<button class="btn btn-info btn-sm" type="button" onclick="Joomla.submitbutton('GoToCpanel')" href="#"><i class="icon-wrench icon-white"></i></button>
													<a href="#modal_firewall_plugin_enabled" role="button" class="btn btn-secondary btn-sm" <?php echo $data;?>toggle="modal"><?php echo Text::_( 'COM_SECURITYCHECKPRO_MORE_INFO' ); ?></a>
												<?php }	?>							
											</li>
										</ul>
										</div>
										...
										<ul class="list-group">
											...
											<li class="list-group-item">
												<?php 
													echo "<span class=\"badge " . $badge_style . "info\">" . Text::_('COM_SECURITYCHECK_AVAILABLE_ONLY_PRO_VERSIONS') . "</span>";
												?>																					
													<a href="#modal_dynamic_blacklist" role="button" class="btn btn-secondary btn-sm" <?php echo $data;?>toggle="modal"><?php echo Text::_( 'COM_SECURITYCHECKPRO_MORE_INFO' ); ?></a>																		
											</li>
										</ul>
										</div>
										...
										<ul class="list-group">
											...
											<li class="list-group-item">
												<?php 
													if ( !$this->system_info['firewall_plugin_enabled'] ) {	
														echo "<span class=\"badge " . $badge_style . "warning\">" . Text::_( 'COM_SECURITYCHECKPRO_ENABLE_FIREWALL_TO_APPLY') . "</span>";
													} else 	if ( $this->system_info['firewall_options']['logs_attacks'] ) {
														echo "<span class=\"badge " . $badge_style . "success\">OK</span>";
													} else {
														echo "<span class=\"badge " . $badge_style . "danger\">" . Text::sprintf( 'COM_SECURITYCHECKPRO_SECURITY_PROBLEM_FOUND',1 ) . "</span>";
												?>
													<button class="btn btn-info btn-sm" type="button" onclick="Joomla.submitbutton('GoToFirewallLogs')" href="#"><i class="icon-wrench icon-white"></i></button>																						
													<a href="#modal_logs_attacks" role="button" class="btn btn-secondary btn-sm" <?php echo $data;?>toggle="modal"><?php echo Text::_( 'COM_SECURITYCHECKPRO_MORE_INFO' ); ?></a>
												<?php }	?>							
											</li>
										</ul>
										</div>
											...
											<li class="list-group-item">
												<?php 
													if ( !$this->system_info['firewall_plugin_enabled'] ) {	
														...
														echo "<span class=\"badge " . $badge_style . "danger\">" . Text::sprintf( 'COM_SECURITYCHECKPRO_SECURITY_PROBLEM_FOUND',1 ) . "</span>";
												?>
													<button class="btn btn-info btn-sm" type="button" onclick="Joomla.submitbutton('GoToFirewallSecondLevel')" href="#"><i class="icon-wrench icon-white"></i></button>																							
													<a href="#modal_second_level" role="button" class="btn btn-secondary btn-sm" <?php echo $data;?>toggle="modal"><?php echo Text::_( 'COM_SECURITYCHECKPRO_MORE_INFO' ); ?></a>
												<?php }	?>							
											</li>
										</ul>
										</div>
											...
											<li class="list-group-item">
												<?php 
													if ( !$this->system_info['firewall_plugin_enabled'] ) {	
														...
														echo "<span class=\"badge " . $badge_style . "danger\">" . Text::sprintf( 'COM_SECURITYCHECKPRO_SECURITY_PROBLEM_FOUND',1 ) . "</span>";
												?>
													<button class="btn btn-info btn-sm" type="button" onclick="Joomla.submitbutton('GoToFirewallExceptions')" href="#"><i class="icon-wrench icon-white"></i></button>																								
													<a href="#modal_exclude_exceptions_if_vulnerable" role="button" class="btn btn-secondary btn-sm" <?php echo $data;?>toggle="modal"><?php echo Text::_( 'COM_SECURITYCHECKPRO_MORE_INFO' ); ?></a>
												<?php }	?>							
											</li>
										</ul>
										</div>
										...
										<ul class="list-group">
											...
											<li class="list-group-item">
												...
												?>
													<button class="btn btn-info btn-sm" type="button" onclick="Joomla.submitbutton('GoToFirewallExceptions')" href="#"><i class="icon-wrench icon-white"></i></button>																							
													<a href="#modal_strip_tags_exceptions" role="button" class="btn btn-secondary btn-sm" <?php echo $data;?>toggle="modal"><?php echo Text::_( 'COM_SECURITYCHECKPRO_MORE_INFO' ); ?></a>
												<?php }	?>							
											</li>
										</ul>
										</div>
										...
										<ul class="list-group">
											...
											<li class="list-group-item">
												...
												?>
													<button class="btn btn-info btn-sm" type="button" onclick="Joomla.submitbutton('GoToFirewallExceptions')" href="#"><i class="icon-wrench icon-white"></i></button>																							
													<a href="#modal_sql_pattern_exceptions" role="button" class="btn btn-secondary btn-sm" <?php echo $data;?>toggle="modal"><?php echo Text::_( 'COM_SECURITYCHECKPRO_MORE_INFO' ); ?></a>
												<?php }	?>							
											</li>
										</ul>
										</div>
										...
										<ul class="list-group">
											...
											<li class="list-group-item">
												...
												?>
													<button class="btn btn-info btn-sm" type="button" onclick="Joomla.submitbutton('GoToFirewallExceptions')" href="#"><i class="icon-wrench icon-white"></i></button>																								
													<a href="#modal_lfi_exceptions" role="button" class="btn btn-secondary btn-sm" <?php echo $data;?>toggle="modal"><?php echo Text::_( 'COM_SECURITYCHECKPRO_MORE_INFO' ); ?></a>
												<?php }	?>							
											</li>
										</ul>
										</div>
											...
											<li class="list-group-item">
												<?php 
													...
													if ( !$this->system_info['firewall_plugin_enabled'] ) {	
														...
														echo "<span class=\"badge " . $badge_style . "danger\">" . Text::sprintf( 'COM_SECURITYCHECKPRO_SECURITY_PROBLEM_FOUND',1 ) . "</span>";
												?>
													<button class="btn btn-info btn-sm" type="button" onclick="Joomla.submitbutton('GoToUserSessionProtection')" href="#"><i class="icon-wrench icon-white"></i></button>																								
													<a href="#modal_session_protection_active" role="button" class="btn btn-secondary btn-sm" <?php echo $data;?>toggle="modal"><?php echo Text::_( 'COM_SECURITYCHECKPRO_MORE_INFO' ); ?></a>
												<?php }	?>							
											</li>
										</ul>
										</div>
										...
										<ul class="list-group">
											...
											<li class="list-group-item">
												<?php 
													echo "<span class=\"badge " . $badge_style . "info\">" . Text::_('COM_SECURITYCHECK_AVAILABLE_ONLY_PRO_VERSIONS') . "</span>";
												?>																						
													<a href="#modal_session_hijack_protection" role="button" class="btn btn-secondary btn-sm" <?php echo $data;?>toggle="modal"><?php echo Text::_( 'COM_SECURITYCHECKPRO_MORE_INFO' ); ?></a>																		
											</li>
										</ul>
										</div>
										...
										<ul class="list-group">
											...
											<li class="list-group-item">
												<?php 
													echo "<span class=\"badge " . $badge_style . "info\">" . Text::_('COM_SECURITYCHECK_AVAILABLE_ONLY_PRO_VERSIONS') . "</span>";
												?>																								
													<a href="#modal_upload_scanner_enabled" role="button" class="btn btn-secondary btn-sm" <?php echo $data;?>toggle="modal"><?php echo Text::_( 'COM_SECURITYCHECKPRO_MORE_INFO' ); ?></a>																	
											</li>
										</ul>
										</div>
										...
										<ul class="list-group">
											...
											<li class="list-group-item">
												<?php 
													echo "<span class=\"badge " . $badge_style . "info\">" . Text::_('COM_SECURITYCHECK_AVAILABLE_ONLY_PRO_VERSIONS') . "</span>";
												?>																							
													<a href="#modal_cron_enabled" role="button" class="btn btn-secondary btn-sm" <?php echo $data;?>toggle="modal"><?php echo Text::_( 'COM_SECURITYCHECKPRO_MORE_INFO' ); ?></a>																			
											</li>
										</ul>
										</div>
											...
											<li class="list-group-item">
												<?php 
													...
													if ( $interval < 2 ) {
														...
														$span = "<span class=\"badge " . $badge_style . "warning\">";
													}
												?>
													...
													?>											
													<button class="btn btn-info btn-sm" type="button" onclick="Joomla.submitbutton('GoToPermissions')" href="#"><i class="icon-wrench icon-white"></i></button>																							
													<a href="#modal_last_check" role="button" class="btn btn-secondary btn-sm" <?php echo $data;?>toggle="modal"><?php echo Text::_( 'COM_SECURITYCHECKPRO_MORE_INFO' ); ?></a>
												<?php }	?>							
											</li>
										</ul>
										</div>
										...
										<ul class="list-group">
											...
											<li class="list-group-item">
												<?php 
													echo "<span class=\"badge " . $badge_style . "info\">" . Text::_('COM_SECURITYCHECK_AVAILABLE_ONLY_PRO_VERSIONS') . "</span>";
												?>																							
													<a href="#modal_last_check_integrity" role="button" class="btn btn-secondary btn-sm" <?php echo $data;?>toggle="modal"><?php echo Text::_( 'COM_SECURITYCHECKPRO_MORE_INFO' ); ?></a>																			
											</li>
										</ul>
										</div>
										...
										<ul class="list-group">
											...
											<li class="list-group-item">
												<?php 
													echo "<span class=\"badge " . $badge_style . "info\">" . Text::_('COM_SECURITYCHECK_AVAILABLE_ONLY_PRO_VERSIONS') . "</span>";
												?>																								
													<a href="#modal_prevent_access" role="button" class="btn btn-secondary btn-sm" <?php echo $data;?>toggle="modal"><?php echo Text::_( 'COM_SECURITYCHECKPRO_MORE_INFO' ); ?></a>																			
											</li>
										</ul>
										</div>
										...
										<ul class="list-group">
											...
											<li class="list-group-item">
												<?php 
													echo "<span class=\"badge " . $badge_style . "info\">" . Text::_('COM_SECURITYCHECK_AVAILABLE_ONLY_PRO_VERSIONS') . "</span>";
												?>																							
													<a href="#modal_prevent_unauthorized_browsing" role="button" class="btn btn-secondary btn-sm" <?php echo $data;?>toggle="modal"><?php echo Text::_( 'COM_SECURITYCHECKPRO_MORE_INFO' ); ?></a>																	
											</li>
										</ul>
										</div>
										...
										<ul class="list-group">
											...
											<li class="list-group-item">
												<?php 
													echo "<span class=\"badge " . $badge_style . "info\">" . Text::_('COM_SECURITYCHECK_AVAILABLE_ONLY_PRO_VERSIONS') . "</span>";
												?>																							
													<a href="#modal_file_injection_protection" role="button" class="btn btn-secondary btn-sm" <?php echo $data;?>toggle="modal"><?php echo Text::_( 'COM_SECURITYCHECKPRO_MORE_INFO' ); ?></a>																		
											</li>
										</ul>
										</div>
										...
										<ul class="list-group">
											...
											<li class="list-group-item">
												<?php 
													echo "<span class=\"badge " . $badge_style . "info\">" . Text::_('COM_SECURITYCHECK_AVAILABLE_ONLY_PRO_VERSIONS') . "</span>";
												?>																						
													<a href="#modal_self_environ" role="button" class="btn btn-secondary btn-sm" <?php echo $data;?>toggle="modal"><?php echo Text::_( 'COM_SECURITYCHECKPRO_MORE_INFO' ); ?></a>																			
											</li>
										</ul>
										</div>
										...
										<ul class="list-group">
											...
											<li class="list-group-item">
												<?php 
													echo "<span class=\"badge " . $badge_style . "info\">" . Text::_('COM_SECURITYCHECK_AVAILABLE_ONLY_PRO_VERSIONS') . "</span>";
												?>																								
													<a href="#modal_xframe_options" role="button" class="btn btn-secondary btn-sm" <?php echo $data;?>toggle="modal"><?php echo Text::_( 'COM_SECURITYCHECKPRO_MORE_INFO' ); ?></a>																		
											</li>
										</ul>
										</div>
										...
										<ul class="list-group">
											...
											<li class="list-group-item">
												<?php 
													echo "<span class=\"badge " . $badge_style . "info\">" . Text::_('COM_SECURITYCHECK_AVAILABLE_ONLY_PRO_VERSIONS') . "</span>";
												?>																						
													<a href="#modal_prevent_mime_attacks" role="button" class="btn btn-secondary btn-sm" <?php echo $data;?>toggle="modal"><?php echo Text::_( 'COM_SECURITYCHECKPRO_MORE_INFO' ); ?></a>																		
											</li>
										</ul>
										</div>
										...
										<ul class="list-group">
											...
											<li class="list-group-item">
												<?php 
													echo "<span class=\"badge " . $badge_style . "info\">" . Text::_('COM_SECURITYCHECK_AVAILABLE_ONLY_PRO_VERSIONS') . "</span>";
												?>																							
													<a href="#modal_default_banned_list" role="button" class="btn btn-secondary btn-sm" <?php echo $data;?>toggle="modal"><?php echo Text::_( 'COM_SECURITYCHECKPRO_MORE_INFO' ); ?></a>																		
											</li>
										</ul>
										</div>
										...
										<ul class="list-group">
											...
											<li class="list-group-item">
												<?php 
													echo "<span class=\"badge " . $badge_style . "info\">" . Text::_('COM_SECURITYCHECK_AVAILABLE_ONLY_PRO_VERSIONS') . "</span>";
												?>																							
													<a href="#modal_disable_server_signature" role="button" class="btn btn-secondary btn-sm" <?php echo $data;?>toggle="modal"><?php echo Text::_( 'COM_SECURITYCHECKPRO_MORE_INFO' ); ?></a>																		
											</li>
										</ul>
										</div>
										...
										<ul class="list-group">
											...
											<li class="list-group-item">
												<?php 
													echo "<span class=\"badge " . $badge_style . "info\">" . Text::_('COM_SECURITYCHECK_AVAILABLE_ONLY_PRO_VERSIONS') . "</span>";
												?>																								
													<a href="#modal_disallow_php_eggs" role="button" class="btn btn-secondary btn-sm" <?php echo $data;?>toggle="modal"><?php echo Text::_( 'COM_SECURITYCHECKPRO_MORE_INFO' ); ?></a>																		
											</li>
										</ul>
										</div>
										...
										<ul class="list-group">
											...
											<li class="list-group-item">
												<?php 
													echo "<span class=\"badge " . $badge_style . "info\">" . Text::_('COM_SECURITYCHECK_AVAILABLE_ONLY_PRO_VERSIONS') . "</span>";
												?>																							
													<a href="#modal_disallow_sensible_files_access" role="button" class="btn btn-secondary btn-sm" <?php echo $data;?>toggle="modal"><?php echo Text::_( 'COM_SECURITYCHECKPRO_MORE_INFO' ); ?></a>																	
											</li>
										</ul>
										</div>								
									</div>
						...
						<div class="tab-pane" id="global_configuration" role="tabpanel">
							...
							<div class="card mb-3">
									<div class="card-header">
										<?php echo Text::_( 'COM_SECURITYCHECK_GLOBAL_CONFIGURATION' ); ?>
									</div>
								<div class="card-body">
									<div class="row">
										<!-- Joomla version -->
										<div class="col-xl-3 mb-3">
											<ul class="list-group">								
												<li class="list-group-item list-group-item-success"><?php echo Text::_( 'COM_SECURITYCHECK_SYSINFO_JOOMLAVERSION' ); ?></li>
										...
										<div class="col-xl-3 mb-3">
											<ul class="list-group">								
												<li class="list-group-item list-group-item-success"><?php echo Text::_( 'COM_SECURITYCHECK_SYSINFO_JOOMLAPLATFORM' ); ?></li>												
											</ul>
										</div>
									</div>
								</div> 
						...
						<div class="tab-pane" id="mysql_configuration" role="tabpanel">
							...
							<div class="card mb-3">
									<div class="card-header">
										<?php echo Text::_( 'COM_SECURITYCHECK_MYSQL_CONFIGURATION' ); ?>
									</div>
								<div class="card-body">
									<div class="row">
										<ul class="list-group">								
											<li class="list-group-item list-group-item-warning"><?php echo Text::_( 'COM_SECURITYCHECK_SYSINFO_MAX_ALLOWED_PACKET' ); ?></li>
						...
						<div class="tab-pane" id="php_configuration" role="tabpanel">
							...
							<div class="card mb-3">
									<div class="card-header">
										<?php echo Text::_( 'COM_SECURITYCHECK_PHP_CONFIGURATION' ); ?>
									</div>
								<div class="card-body">
									<div class="row">
										<!-- Phpversion -->
										<div class="col-xl-3 mb-3">
											<ul class="list-group">								
												<li class="list-group-item list-group-item-secondary"><?php echo Text::_( 'COM_SECURITYCHECK_SYSINFO_PHPVERSION' ); ?></li>
										...
										<div class="col-xl-3 mb-3">
											<ul class="list-group">								
												<li class="list-group-item list-group-item-secondary"><?php echo Text::_( 'COM_SECURITYCHECK_SYSINFO_MEMORY_LIMIT' ); ?></li>
...
<input type="hidden" name="controller" value="sysinfo" />
</form>
