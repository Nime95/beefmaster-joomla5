...
namespace SecuritycheckExtensions\Component\Securitycheck\Administrator\View\Sysinfo;
...
class HtmlView extends BaseHtmlView {
    ...
    function display($tpl = null) {
		...
		ToolBarHelper::title( Text::_( 'Securitycheck' ).' | ' .Text::_('COM_SECURITYCHECK_SYSTEM_INFORMATION'), 'securitycheck' );
