...
abstract class ModQuixInfoHelper
{
  ...
  */
    ...
    {
        \Joomla\CMS\MVC\Model\BaseDatabaseModel::addIncludePath(JPATH_ADMINISTRATOR.'/components/com_quix/models');

        $config = \Joomla\CMS\MVC\Model\BaseDatabaseModel::getInstance('Config', 'QuixModel', array('ignore_request' => false));
