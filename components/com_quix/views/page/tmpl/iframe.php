...
if ($this->item->builder == 'classic') {
    ...
    // Load assets
    Factory::getDocument()->addScript(JUri::root(true) . '/libraries/quix/assets/js/cookies.js');
    Factory::getDocument()->addScript(JUri::root(true) . '/libraries/quix/assets/js/quix-toolbar.js');
    Factory::getDocument()->addStylesheet(JUri::root(true) . '/libraries/quix/assets/css/quix-classic.css');
}
