...
if ($showPreview)
{
	...
	$img = JHtml::_('image', $src, Text::_('JLIB_FORM_MEDIA_PREVIEW_ALT'), $imgattr);
...
<?php echo ($readonly ? ''
 ...
 <?php echo Text::_('JLIB_FORM_BUTTON_SELECT'); ?></a>
 <a class="btn hasTooltip" title="<?php echo Text::_('JLIB_FORM_BUTTON_CLEAR'); ?>" href="#" onclick="jInsertFieldValue('', '<?php echo $id; ?>'); return false;">
