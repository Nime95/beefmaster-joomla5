 ...
 * @since       2.5.5
 */
class PlgSystemJMedia extends CMSPlugin
{
    /**
    ...
    public function onAfterRoute()
    {
        ...
        $replaceMedia = (bool) $params->get('replace_media_manager', false);
    ...
    public function onContentPrepareForm($form, $data)
    {
        ...
        $params = ComponentHelper::getParams('com_jmedia');
        $replace_media_manager = (bool) $params->get('replace_media_manager', true);
